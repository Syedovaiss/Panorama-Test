...
#include "/Users/syedovaisakhtar/AndroidStudioProjects/Panorama/nativecore/src/main/cpp/opencv/modules/dnn/misc/java/src/cpp/dnn_converters.hpp"
#include "/Users/syedovaisakhtar/AndroidStudioProjects/Panorama/nativecore/src/main/cpp/opencv/modules/dnn/include/opencv2/dnn/dict.hpp"
#include "/Users/syedovaisakhtar/AndroidStudioProjects/Panorama/nativecore/src/main/cpp/opencv/modules/dnn/include/opencv2/dnn/dnn.hpp"
#include "/Users/syedovaisakhtar/AndroidStudioProjects/Panorama/nativecore/src/main/cpp/opencv/modules/dnn/include/opencv2/dnn/utils/inference_engine.hpp"
...
JNIEXPORT jlong JNICALL Java_org_opencv_dnn_Image2BlobParams_Image2BlobParams_11 (JNIEnv*, jclass, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jboolean, jint, jint, jdouble, jdouble, jdouble, jdouble);

JNIEXPORT jlong JNICALL Java_org_opencv_dnn_Image2BlobParams_Image2BlobParams_11
  (JNIEnv* env, jclass , jdouble scalefactor_val0, jdouble scalefactor_val1, jdouble scalefactor_val2, jdouble scalefactor_val3, jdouble size_width, jdouble size_height, jdouble mean_val0, jdouble mean_val1, jdouble mean_val2, jdouble mean_val3, jboolean swapRB, jint ddepth, jint datalayout, jdouble borderValue_val0, jdouble borderValue_val1, jdouble borderValue_val2, jdouble borderValue_val3)
{
    using namespace cv::dnn;
    ...
    try {
        ...
        cv::dnn::Image2BlobParams* _retval_ = new cv::dnn::Image2BlobParams( scalefactor, size, mean, (bool)swapRB, (int)ddepth, (cv::dnn::DataLayout)datalayout, dnn::DNN_PMODE_NULL, borderValue );
        return (jlong) _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
JNIEXPORT jlong JNICALL Java_org_opencv_dnn_Image2BlobParams_Image2BlobParams_12 (JNIEnv*, jclass, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jboolean, jint, jint);

JNIEXPORT jlong JNICALL Java_org_opencv_dnn_Image2BlobParams_Image2BlobParams_12
  (JNIEnv* env, jclass , jdouble scalefactor_val0, jdouble scalefactor_val1, jdouble scalefactor_val2, jdouble scalefactor_val3, jdouble size_width, jdouble size_height, jdouble mean_val0, jdouble mean_val1, jdouble mean_val2, jdouble mean_val3, jboolean swapRB, jint ddepth, jint datalayout)
{
    using namespace cv::dnn;
    ...
    try {
        ...
        Size size((int)size_width, (int)size_height);
        Scalar mean(mean_val0, mean_val1, mean_val2, mean_val3);
        cv::dnn::Image2BlobParams* _retval_ = new cv::dnn::Image2BlobParams( scalefactor, size, mean, (bool)swapRB, (int)ddepth, (cv::dnn::DataLayout)datalayout, dnn::DNN_PMODE_NULL );
        return (jlong) _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
JNIEXPORT jlong JNICALL Java_org_opencv_dnn_Image2BlobParams_Image2BlobParams_14 (JNIEnv*, jclass, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jboolean, jint);

JNIEXPORT jlong JNICALL Java_org_opencv_dnn_Image2BlobParams_Image2BlobParams_14
...
{
    using namespace cv::dnn;
    static const char method_name[] = "dnn::Image2BlobParams_14()";
    try {
        LOGD("%s", method_name);
        Scalar scalefactor(scalefactor_val0, scalefactor_val1, scalefactor_val2, scalefactor_val3);
        Size size((int)size_width, (int)size_height);
        Scalar mean(mean_val0, mean_val1, mean_val2, mean_val3);
        cv::dnn::Image2BlobParams* _retval_ = new cv::dnn::Image2BlobParams( scalefactor, size, mean, (bool)swapRB, (int)ddepth );
        return (jlong) _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
//
// dnn_DataLayout Image2BlobParams::datalayout
//

JNIEXPORT jint JNICALL Java_org_opencv_dnn_Image2BlobParams_get_1datalayout_10 (JNIEnv*, jclass, jlong);

JNIEXPORT jint JNICALL Java_org_opencv_dnn_Image2BlobParams_get_1datalayout_10
  (JNIEnv* env, jclass , jlong self)
{
    using namespace cv::dnn;
    static const char method_name[] = "dnn::get_1datalayout_10()";
    try {
        LOGD("%s", method_name);
        cv::dnn::Image2BlobParams* me = (cv::dnn::Image2BlobParams*) self; //TODO: check for NULL
        return me->datalayout;//();
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
...
JNIEXPORT void JNICALL Java_org_opencv_dnn_Image2BlobParams_set_1datalayout_10 (JNIEnv*, jclass, jlong, jint);

JNIEXPORT void JNICALL Java_org_opencv_dnn_Image2BlobParams_set_1datalayout_10
  (JNIEnv* env, jclass , jlong self, jint datalayout)
{
    using namespace cv::dnn;
    static const char method_name[] = "dnn::set_1datalayout_10()";
    try {
        LOGD("%s", method_name);
        cv::dnn::Image2BlobParams* me = (cv::dnn::Image2BlobParams*) self; //TODO: check for NULL
        me->datalayout = ( (cv::dnn::DataLayout)datalayout );
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
...
//
// dnn_ImagePaddingMode Image2BlobParams::paddingmode
//

JNIEXPORT jint JNICALL Java_org_opencv_dnn_Image2BlobParams_get_1paddingmode_10 (JNIEnv*, jclass, jlong);

JNIEXPORT jint JNICALL Java_org_opencv_dnn_Image2BlobParams_get_1paddingmode_10
  (JNIEnv* env, jclass , jlong self)
{
    using namespace cv::dnn;
    static const char method_name[] = "dnn::get_1paddingmode_10()";
    try {
        LOGD("%s", method_name);
        cv::dnn::Image2BlobParams* me = (cv::dnn::Image2BlobParams*) self; //TODO: check for NULL
        return me->paddingmode;//();
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
...
JNIEXPORT void JNICALL Java_org_opencv_dnn_Image2BlobParams_set_1paddingmode_10 (JNIEnv*, jclass, jlong, jint);

JNIEXPORT void JNICALL Java_org_opencv_dnn_Image2BlobParams_set_1paddingmode_10
  (JNIEnv* env, jclass , jlong self, jint paddingmode)
{
    using namespace cv::dnn;
    static const char method_name[] = "dnn::set_1paddingmode_10()";
    try {
        LOGD("%s", method_name);
        cv::dnn::Image2BlobParams* me = (cv::dnn::Image2BlobParams*) self; //TODO: check for NULL
        me->paddingmode = ( (cv::dnn::ImagePaddingMode)paddingmode );
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
...
JNIEXPORT jint JNICALL Java_org_opencv_dnn_Net_registerOutput_10 (JNIEnv*, jclass, jlong, jstring, jint, jint);

JNIEXPORT jint JNICALL Java_org_opencv_dnn_Net_registerOutput_10
  (JNIEnv* env, jclass , jlong self, jstring outputName, jint layerId, jint outputPort)
{
    using namespace cv::dnn;
    static const char method_name[] = "dnn::registerOutput_10()";
    try {
        LOGD("%s", method_name);
        cv::dnn::Net* me = (cv::dnn::Net*) self; //TODO: check for NULL
        const char* utf_outputName = env->GetStringUTFChars(outputName, 0); std::string n_outputName( utf_outputName ? utf_outputName : "" ); env->ReleaseStringUTFChars(outputName, utf_outputName);
        return me->registerOutput( n_outputName, (int)layerId, (int)outputPort );
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
