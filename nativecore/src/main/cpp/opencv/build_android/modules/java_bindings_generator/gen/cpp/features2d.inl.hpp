...
#include "/Users/syedovaisakhtar/AndroidStudioProjects/Panorama/nativecore/src/main/cpp/opencv/modules/features2d/misc/java/src/cpp/features2d_converters.hpp"
#include "/Users/syedovaisakhtar/AndroidStudioProjects/Panorama/nativecore/src/main/cpp/opencv/modules/features2d/include/opencv2/features2d.hpp"
...
JNIEXPORT jbyte JNICALL Java_org_opencv_features2d_SimpleBlobDetector_1Params_get_1blobColor_10 (JNIEnv*, jclass, jlong);

JNIEXPORT jbyte JNICALL Java_org_opencv_features2d_SimpleBlobDetector_1Params_get_1blobColor_10
  (JNIEnv* env, jclass , jlong self)
{
    
    static const char method_name[] = "features2d::get_1blobColor_10()";
    try {
        LOGD("%s", method_name);
        cv::SimpleBlobDetector::Params* me = (cv::SimpleBlobDetector::Params*) self; //TODO: check for NULL
        return me->blobColor;//();
...
JNIEXPORT void JNICALL Java_org_opencv_features2d_SimpleBlobDetector_1Params_set_1blobColor_10 (JNIEnv*, jclass, jlong, jbyte);

JNIEXPORT void JNICALL Java_org_opencv_features2d_SimpleBlobDetector_1Params_set_1blobColor_10
  (JNIEnv* env, jclass , jlong self, jbyte blobColor)
{
    
    static const char method_name[] = "features2d::set_1blobColor_10()";
    try {
        LOGD("%s", method_name);
        cv::SimpleBlobDetector::Params* me = (cv::SimpleBlobDetector::Params*) self; //TODO: check for NULL
        me->blobColor = ( (uchar)blobColor );
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
